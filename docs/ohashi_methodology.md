...
- NOT SPECIFIED BY OHASHI: pixel-domain VIFp vs wavelet-domain VIF.
...
- NOT SPECIFIED BY OHASHI: dropout probability; whether the RadImageNet
  backbone is frozen or fine-tuned; exact grayscale-to-3-channel
