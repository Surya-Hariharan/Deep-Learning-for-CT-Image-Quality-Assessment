...
Source: weights/pretrained/RadImageNet-ResNet50_notop.h5
    ...
    - Keras's default BatchNormalization epsilon is 1e-3; PyTorch's default
      `nn.BatchNorm2d` epsilon is 1e-5. This script does not change that
...
Usage:
    python scripts/convert_radimagenet_weights.py \
        --input weights/pretrained/RadImageNet-ResNet50_notop.h5 \
        --output weights/pretrained/radimagenet_resnet50_backbone.pt
"""
...
def main() -> None:
    ...
    parser.add_argument("--input", default="weights/pretrained/RadImageNet-ResNet50_notop.h5")
    parser.add_argument("--output", default="weights/pretrained/radimagenet_resnet50_backbone.pt")
